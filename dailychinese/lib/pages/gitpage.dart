...
class GitPage extends StatefulWidget {
  GitPage({Key key, this.title}) : super(key: key);
  ...
  @override
  _GitPageState createState() => new _GitPageState();
}

class _GitPageState extends State<GitPage> with AutomaticKeepAliveClientMixin {

...
class AdsPage extends StatefulWidget {
  const AdsPage({this.initOption, Key key}) : super(key: key);

  final int initOption;
  @override
  _AdsPageState createState() => _AdsPageState(initOption: initOption);
}


class _AdsPageState extends State<AdsPage> {
  _AdsPageState({this.initOption = 1});

  final int initOption;
  int _coins = 0;

  final String appId = Platform.isAndroid
      ? 'ca-app-pub-1962140952663321~5499996004'
      : 'ca-app-pub-3940256099942544~1458002511';
  final String bannerUnitId = Platform.isAndroid
      ? 'ca-app-pub-1962140952663321/4215119906'
      : 'ca-app-pub-3940256099942544/2934735716';
  final String screenUnitId = Platform.isAndroid
      ? 'ca-app-pub-1962140952663321/1588956565'
      : 'ca-app-pub-3940256099942544/4411468910';
  final String videoUnitId = Platform.isAndroid
      ? 'ca-app-pub-1962140952663321/9275874897'
